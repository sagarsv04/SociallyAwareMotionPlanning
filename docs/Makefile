...
# Files of interest
EXCLUDE_TEX = %.diff.tex %.old.tex
all_files.tex		?= $(filter-out $(EXCLUDE_TEX),$(wildcard *.tex))
...
.PHONY: diff
diff: main.diff.tex main.diff.pdf

viewdiff: main.diff.pdf
	$(QUIET)$(VIEW_PDF) main.diff.pdf &

main.diff.tex: main.tex main.old.tex
	$(QUIET)$(DIFFUTIL) main.old.tex main.tex > main.diff.tex
